...
TEST_CASE("Grammar2::DEF_DOMAIN") {
    ...
    CHECK(testParse(grammar.DEF_DOMAIN, ".domain ByteArray: [256]Byte", Production::DEF_DOMAIN));
...
TEST_CASE("Grammar2::DEF_CMD_PARMTYPE_NAME") {
    ...
    CHECK(testParse(grammar.DEF_CMD_PARM_TYPE, "String", Production::DEF_CMD_PARMTYPE_NAME));
    CHECK(testParse(grammar.DEF_CMD_PARM_TYPE, "^Int", Production::DEF_CMD_PARMTYPE_NAME));
    CHECK(testParse(grammar.DEF_CMD_PARM_TYPE, "[]List[T]", Production::DEF_CMD_PARMTYPE_NAME));
    CHECK(testParse(grammar.DEF_CMD_PARM_TYPE, "(T: Int)", Production::DEF_CMD_PARMTYPE_VAR));
    CHECK(testParse(grammar.DEF_CMD_PARM_TYPE, "(U: []List[T])", Production::DEF_CMD_PARMTYPE_VAR));
    CHECK(testParse(grammar.DEF_CMD_PARM_TYPE, "?<Int', String>", Production::DEF_CMD_PARMTYPE_NAME));
...
TEST_CASE("Grammar2::CALL_EXPR_SUFFIX - dereference operator") {
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "myPtr^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "42^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "3.14^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "\"hello\"^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(x + y)^", Production::SUBCALL_EXPRESSION));
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^ + y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + ptr^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr1^ * ptr2^", Production::SUBCALL_EXPRESSION));
}

TEST_CASE("Grammar2::CALL_EXPR_SUFFIX - address-of operator") {
    Grammar2& grammar = getGrammar();

    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "myVar&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "42&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "3.14&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "\"hello\"&", Production::SUBCALL_EXPRESSION));
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(Widget: x, y)&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x& + y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + b&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x& * y&", Production::SUBCALL_EXPRESSION));
}
...
TEST_CASE("Grammar2::CALL_EXPR_SUFFIX - array indexing") {
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data[i]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "items[index]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "myArray[42]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "matrix[i, j]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "grid[0, 0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "table[row, col]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[0][1]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data[i][j]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "cube[x][y][z]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "nested[0][1][2][3]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[i, j][k]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data[0][i, j]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "complex[a, b][c][d, e]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[i + 1]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data[x * 2]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "items[a + b, c - d]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "42[0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "\"text\"[i]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(x + y)[0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(doIt)[i]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(Widget: x, y)[0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((a + b) * c)[index]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[0] + arr[1]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data[i] * data[j]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x + arr[i]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "matrix[i, j] - offset", Production::SUBCALL_EXPRESSION));
}

TEST_CASE("Grammar2::CALL_EXPR_SUFFIX - combined operations") {
    Grammar2& grammar = getGrammar();

    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[i][j][k] + data[x][y]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "matrix[0, 0] * matrix[1, 1]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[i + j]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data[x * 2, y / 2]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "items[(a + b)]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[0]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^[0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^[i][j]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^[0]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^[i, j]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "data^[0][1][2]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^ + offset", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr^[i] * scale", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "ptr1^[0] + ptr2^[1]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr^&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr[0]^",Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "arr^^", Production::SUBCALL_EXPRESSION));
...
TEST_CASE("Grammar2::CALL_EXPR_SUFFIX - ordering rules") {
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x[0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^[0]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x[0]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^[0]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^[0][1]", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^[0][1]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^[i, j][k]&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x[0]^", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x[0]^&", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x^^", Production::SUBCALL_EXPRESSION));
...
TEST_CASE("Grammar2::CALL_EXPRESSION") {
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((Widget: x, y))", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(List[Int]: item)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(process: item)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(doIt)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "someVariable", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((obj):: method: x)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((a, b):: handle: item)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(process: (Widget: x, y))", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "({doIt}: data)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "({Widget: x, y})", Production::SUBCALL_EXPRESSION));
...
TEST_CASE("Grammar2::CALL_CMD_LITERAL") {
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<Int x>{Widget: x, y}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<String name>{Container: name}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<Int value>{List[Int]: value}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<String data>{Map[String, Int]: data, count}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<Int count>{Array[8]: count}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<Int x>{process: x}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<String name>{doIt}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<Int value>{calculate: value, value}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<String data>{validate: data}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<Int x>{(obj):: method: x}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<String name>{(a, b):: handle: name}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<Int value>{(widget):: process}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<Int x, String y>{Widget: x, y}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<Int a, Int b, Int c>{calculate: a, b, c}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<String name, Int count>{process: name, count}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<Int x, String y, Int z>{(obj):: method: x, y, z}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<^Int ptr>{process: ptr}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<[]Int items>{calculate: items}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<[8]Int buffer>{validate: buffer}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<List[T] list>{Widget: list}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<^[]Int data>{process: data}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<Map[String, Int] map>{doIt}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<(T: Int) value>{process: value}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<(T: String) data>{Widget: data}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<(U: List[T]) items>{calculate: items}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, ":<Int x, ^String ptr, []Int items>{process: x, ptr, items}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "?<String name, (T: Int) value>{Widget: name, value}", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "!<List[T] list, Int count, ^Int ptr>{(obj):: method: list, count, ptr}", Production::SUBCALL_EXPRESSION));
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION,
        "?<String name, Int count>{%doIt\n"
                "                           cleanup}", Production::SUBCALL_EXPRESSION));
...
TEST_CASE("Grammar2::DEF_CMD_BODY - complex scenarios") {
    ...
    CHECK(debugTestParse(grammar.CALL_CONSTRUCTOR, "Processor: ({doIt}: x)", Production::CALL_CONSTRUCTOR));
...
TEST_CASE("Grammar2::CALL_OPERATOR") {
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + b", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x - y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "m * n", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "p / q", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a << b", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x >> y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + b + c", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x - y - z", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a * b * c * d", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "p / q / r", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + b * c", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x - y / z", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a * b + c * d", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "p / q - r / s", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + b - c * d / e", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(a + b) * c", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x * (y + z)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(a + b) * (c - d)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((a + b) * c) / d", Production::SUBCALL_EXPRESSION));
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(((x))) + y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((a + (b * c))) / d", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "value << 8", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "bits >> 4", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a << b << c", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x >> y >> z", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a << 1 + b", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "x >> 2 * y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(a << b) + c", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + (b >> c)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(Widget: x, y) + z", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + (process: item)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(doIt) * (calculate: x)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((obj):: method: x) + y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a + ((b, c):: handle: item)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "Module::value + x", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "a * Std::Math::pi", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "Module::function: x, y", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(UI::Widget: x, y) + offset", Production::SUBCALL_EXPRESSION));
    ...
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "((a + b) * (c - d)) / ((e + f) * g)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "(Widget: x, y) + (process: a) * (calculate: b)", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.CALL_ASSIGNMENT, "result <- ((a + b) * c) + ((d - e) / f)", Production::CALL_ASSIGNMENT));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "width + height", Production::SUBCALL_EXPRESSION));
    CHECK(testParse(grammar.SUBCALL_EXPRESSION, "total - discount + tax", Production::SUBCALL_EXPRESSION));
    ...
    CHECK(testParse(grammar.CALL_ASSIGNMENT, "isGreater <- x > y", Production::CALL_ASSIGNMENT));
    ...
    CHECK(testParse(grammar.CALL_ASSIGNMENT, "equals <- x = y", Production::CALL_ASSIGNMENT));
