...
\text{scope boundary}\quad & v=scope(c) \quad \langle v, \Phi, \Sigma \rangle & \implies & \langle c,\epsilon,\Sigma \rangle \quad \vec{c} \leftarrow \langle \vec{v},\Phi,\Sigma \rangle \\
